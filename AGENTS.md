...
| Footer | Emphasized real acceptance action, Escape, then at most five complete capability hints on the full screen; keyboard-guide access gets first priority, followed by the available filter/exclusion toggle, and the guide retains all applicable keys |
